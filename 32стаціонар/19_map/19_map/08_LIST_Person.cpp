...
public:            // no-arg constructor
	...
	string get_lastName() const // return phone number
	{
		return lastName;
	}
};
...
{
	return tolower(p.get_lastName().at(0)) == 'm';
}
////////////////////////////////////////////////////////////////
int main()
{
	...
	auto it = find_if(persList.begin(), persList.end(), findPerson);
	(*it).display();
	char ch;
	cin >> ch;
	cout << endl;

	copy_if(persList.begin(), persList.end(), ostream_iterator<person>(cout, ","), [ch](person& el) {return tolower(el.get_lastName().at(0)) == ch; });
	cout << endl;
